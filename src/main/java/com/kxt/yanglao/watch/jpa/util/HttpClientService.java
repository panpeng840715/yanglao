...
public class HttpClientService {
     ...
     * @throws Exception
     */
    public static Object sendGet(String url, List<NameValuePair> nameValuePairList,String strToken) throws Exception {
        ...
        try {
            ...
            httpGet.setHeader(new BasicHeader("AccessToken", strToken));
            httpGet.setHeader(new BasicHeader("User-Agent", "MSIE"));
            /**
             * 设置返回编码
             */
     ...
     * @throws Exception
     */
    public static Object sendPost(String url, String nameValuePairList,String strToken) throws Exception {
        JSONObject jsonObject = null;
        CloseableHttpClient client = null;
        CloseableHttpResponse response = null;
        try {
             ...
             * 包装成一个Entity对象
             */
            StringEntity entity = new StringEntity(nameValuePairList,"UTF-8");
            ...
            post.setHeader(new BasicHeader("AccessToken", strToken));
            post.setHeader(new BasicHeader("User-Agent", "MSIE"));
            /**
             * 设置请求的报文头部的编码
             */
